...
public class INT64Test {
    private static final BigInteger MIN_INTEGER_VALUE = BigIntegerUtils.minOfSigned(INT64.SIZE_IN_BYTES);
    private static final BigInteger MAX_INTEGER_VALUE = BigIntegerUtils.maxOfSigned(INT64.SIZE_IN_BYTES);

    private static final INT64 V1 = new INT64(1);
    private static final INT64 V2 = new INT64(2);
    private static final INT64 V3 = new INT64(3);
    ...
    public void constructWithTooShortValue() {
        // act
        new INT64(MIN_INTEGER_VALUE.subtract(BigInteger.ONE));
    }

    @Test(expected = IllegalArgumentException.class)
    public void constructWithTooBigValue() {
        // act
        new INT64(MAX_INTEGER_VALUE.add(BigInteger.ONE));
    }
    ...
    public void constructWithMinValueAndGet() {
        ...
        byte[] expectedBytes = new byte[]{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, (byte) 0x80};
    ...
    public void constructWithMaxValueAndGet() {
        ...
        byte[] expectedBytes = new byte[]{(byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0xff, (byte) 0x7f};
    ...
    public void readTooShortInputStream() throws IOException {
        // given
        InputStream given = new ByteArrayInputStream(new byte[INT64.SIZE_IN_BYTES - 1]);
    ...
    public void readZero() throws IOException {
        // given
        InputStream given = new ByteArrayInputStream(new INT64(BigInteger.valueOf(0)).bytes());

        // expected
        INT64 expected = new INT64(BigInteger.valueOf(0));

        // act
        INT64 actual = INT64.read(given);
    ...
    public void readPositiveValue() throws IOException {
        // given
        InputStream given = new ByteArrayInputStream(new INT64(1).bytes());

        // expected
        INT64 expected = new INT64(1);
    ...
    public void readMaxValue() throws IOException {
        // given
        InputStream given = new ByteArrayInputStream(INT64.MAX_VALUE.bytes());
    ...
    public void testToString() {
        ...
        assertThat(INT64.ZERO.toString(), is("0x0000000000000000"));
        assertThat(INT64.MIN_VALUE.toString(), is("0x8000000000000000"));
        assertThat(INT64.MAX_VALUE.toString(), is("0x7fffffffffffffff"));
    }
}
