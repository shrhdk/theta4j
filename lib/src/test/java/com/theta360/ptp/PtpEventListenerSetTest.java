...
import static com.theta360.ptp.code.EventCode.*;
...
public class PtpEventListenerSetTest {
    ...
    public void raiseUndefined() {
        // given
        Event given = new Event(UNDEFINED.value(), SESSION_ID, TRANSACTION_ID);
    ...
    public void raiseCancelTransaction() {
        // given
        Event given = new Event(CANCEL_TRANSACTION.value(), SESSION_ID, TRANSACTION_ID);
    ...
    public void raiseObjectAdded() {
        // given
        Event given = new Event(OBJECT_ADDED.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseObjectRemoved() {
        // given
        Event given = new Event(OBJECT_REMOVED.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseStoreAdded() {
        // given
        Event given = new Event(STORE_ADDED.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseStoreRemoved() {
        // given
        Event given = new Event(STORE_REMOVED.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseDevicePropChanged() {
        // given
        Event given = new Event(DEVICE_PROP_CHANGED.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseObjectInfoChanged() {
        // given
        Event given = new Event(OBJECT_INFO_CHANGED.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseDeviceInfoChanged() {
        // given
        Event given = new Event(DEVICE_INFO_CHANGED.value(), SESSION_ID, TRANSACTION_ID);
    ...
    public void raiseRequestObjectTransfer() {
        // given
        Event given = new Event(REQUEST_OBJECT_TRANSFER.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseStoreFull() {
        // given
        Event given = new Event(STORE_FULL.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseDeviceReset() {
        // given
        Event given = new Event(DEVICE_RESET.value(), SESSION_ID, TRANSACTION_ID);
    ...
    public void raiseStorageInfoChanged() {
        // given
        Event given = new Event(STORAGE_INFO_CHANGED.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseCaptureComplete() {
        // given
        Event given = new Event(CAPTURE_COMPLETE.value(), SESSION_ID, TRANSACTION_ID, P1);
    ...
    public void raiseUnreportedStatus() {
        // given
        Event given = new Event(UNREPORTED_STATUS.value(), SESSION_ID, TRANSACTION_ID);
